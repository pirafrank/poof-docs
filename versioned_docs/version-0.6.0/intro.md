...
- **Getting started** - Installation instructions and initial setup
- **Feature list** - Complete list of features and supported commands
- **Documentation** - In-depth guides and explanations
